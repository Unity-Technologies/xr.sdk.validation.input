...
public class ControlTest1DDefault : ControlTest
{
    ...
    {
        Description = "1D Axis control should default to 0.0 when not the control is not actuated. Verify that the device defaults to 0.0 and then manually pass this test.";
        CertReqID = "1.2.3.x";
